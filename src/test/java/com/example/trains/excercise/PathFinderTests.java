...
public class PathFinderTests {
    ...
    public void testSimpleStepGraph(){
        ...
        Route bestRoute = pathFinderService.findBestRoute(graphModel, new Station("A"), new Station("C"));
    ...
    public void testTwoStepsGraph(){
        ...
        Route bestRoute = pathFinderService.findBestRoute(graphModel, new Station("A"), new Station("D"));
    ...
    public void testNoRouteGraph(){
        ...
        pathFinderService.findBestRoute(graphModel, new Station("B"), new Station("D"));
    }
    ...
    public void testStationFromNotFound(){
        ...
        pathFinderService.findBestRoute(graphModel, new Station("F"), new Station("A"));
    }
    ...
    public void testStationToNotFound(){
        ...
        pathFinderService.findBestRoute(graphModel, new Station("A"), new Station("F"));
    }
    ...
    public void testSameFromTo(){
        ...
        pathFinderService.findBestRoute(graphModel, new Station("A"), new Station("A"));
    }
    ...
    public void testNullFrom(){
        ...
        pathFinderService.findBestRoute(graphModel, null, new Station("A"));
    }
    ...
    public void testNullTo(){
        ...
        pathFinderService.findBestRoute(graphModel, new Station("A"), null );
    }
}
